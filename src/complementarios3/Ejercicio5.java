...
public class Ejercicio5 {
    public static void main(String[] args) {
        List<Alumno> alumnos = List.of(new Alumno("Homero", "Simpson", LocalDate.of(1984, 5, 12)),
        ...
        Map<String, Integer> alumnosMap = alumnos.stream().collect(Collectors
                .toMap(
                    (a) -> (a.getLastName() + " " + a.getName()), 
                    (a) -> age(LocalDate.now(), a.getBirthDate())));
